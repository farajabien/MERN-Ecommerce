...
//SET_FULL_IMAGE_URL ex: http://127.0.0.1:5001/users/user-(1).jpg
// @desc We save just name of image in the database (user-(1).jpg), we need to get full link url to the image to access it in the frontend, so here we need to put the base url (http://127.0.0.1:5001) of the server before we do read, update and create
